...
export const Route = createFileRoute("/book")({
  ...
  head: () => ({
    meta: [
      ...
      { property: "og:url", content: "https://www.legendfade.com/book" },
      { property: "og:site_name", content: "Legend Fade" },
      { property: "og:image", content: "https://www.legendfade.com/images/hero-bg.jpg" },
      ...
      { name: "twitter:image", content: "https://www.legendfade.com/images/hero-bg.jpg" },
    ],
  }),
  component: BookPage,
});
